...
// ============================================================
// Interactive half of the Ads (CTWA) page — the range switcher and
// the render of whichever range's data is current. Seeded with the
// server-rendered default range (see page.tsx) — see analytics-client
...
export function AdsCtwaClient({
  initialRange,
  initialData,
  initialError,
}: {
  initialRange: RangeValue;
  initialData: CtwaAttribution | null;
