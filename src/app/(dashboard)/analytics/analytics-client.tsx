...
// ============================================================
// Interactive half of the Analytics page — the range switcher and
// the render of whichever range's data is current. Seeded with the
// server-rendered default range (see page.tsx) so switching ranges
// is the only time this fetches client-side; the initial load never
...
export function AnalyticsClient({
  ...
  useEffect(() => {
    // Already have this range's data — either the initial server
    // render, or a range we've already fetched. Nothing to do.
    if (range === result.range) return;
    let cancelled = false;
