...
//   on the list falls through to the last-resort fallback below with
...
//
// Previous implementation hard-defaulted to the upstream wacrm
// project's own marketing site, which 404s on `/join/<token>` for
// anyone who forked it without setting `NEXT_PUBLIC_SITE_URL`. Set
// that env var to your canonical URL so this fallback is never hit.
...
function getBaseUrl(request: Request): string {
  ...
  return "https://wacrmjlbsystems.vercel.app";
}
